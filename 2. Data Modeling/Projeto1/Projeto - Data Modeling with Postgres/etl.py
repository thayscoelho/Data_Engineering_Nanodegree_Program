...
def process_song_file(cur, filepath):
    """Reads songs file, select fields and inserts them into song and artist tables.
        Parameters:
...
def process_log_file(cur, filepath):
    """Reads user activity log file, filters by NexSong, select fields, transform them and insert into time, user and songplay tables.
            Parameters:
                cur (psycopg2.cursor()): Cursor of the sparkifydb database
                filepath (str): Filepath of the file to be analyzed
    """
